...
from app.schemas.lista_millaisenasaatu import ListaMillaisenasaatu as Schema, ListaMillaisenasaatuPage as SchemaPage  # lista_millaisenasaatu: list received as
