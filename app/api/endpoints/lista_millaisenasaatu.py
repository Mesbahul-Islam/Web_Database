...
from app.models.lista_millaisenasaatu import ListaMillaisenasaatu as Model  # lista_millaisenasaatu: list received as
from app.schemas.lista_millaisenasaatu import ListaMillaisenasaatu as Schema, ListaMillaisenasaatuPage as SchemaPage, ListaMillaisenasaatuCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_millaisenasaatu")
def read_all(
    request: Request,
