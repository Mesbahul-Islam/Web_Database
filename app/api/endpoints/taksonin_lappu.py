...
from app.models.taksonin_lappu import TaksoninLappu as Model  # taksonin_lappu: taxon_label
from app.schemas.taksonin_lappu import TaksoninLappu as Schema, TaksoninLappuPage as SchemaPage  # taksonin_lappu: taxon_label

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("taksonin_lappu")
def read_all(
    request: Request,
