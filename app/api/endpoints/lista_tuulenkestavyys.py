...
from app.schemas.lista_tuulenkestavyys import ListaTuulenkestavyys as Schema, ListaTuulenkestavyysPage as SchemaPage  # lista_tuulenkestavyys: list wind hardiness
