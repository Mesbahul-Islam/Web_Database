...
from app.models.lista_tuulenkestavyys import ListaTuulenkestavyys as Model  # lista_tuulenkestavyys: list wind hardiness
from app.schemas.lista_tuulenkestavyys import ListaTuulenkestavyys as Schema, ListaTuulenkestavyysPage as SchemaPage, ListaTuulenkestavyysCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_tuulenkestavyys")
def read_all(
    request: Request,
