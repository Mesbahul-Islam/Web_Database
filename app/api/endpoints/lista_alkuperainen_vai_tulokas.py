...
from app.schemas.lista_alkuperainen_vai_tulokas import ListaAlkuperainenVaiTulokas as Schema, ListaAlkuperainenVaiTulokasPage as SchemaPage, ListaAlkuperainenVaiTulokasCreate as SchemaCreate
