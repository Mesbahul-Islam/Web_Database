...
from app.schemas.lista_kayttotarkoitus import ListaKayttotarkoitus as Schema, ListaKayttotarkoitusPage as SchemaPage  # lista_kayttotarkoitus: list_usage_purpose
