...
from app.models.lista_kayttotarkoitus import ListaKayttotarkoitus as Model  # lista_kayttotarkoitus: list_usage_purpose
from app.schemas.lista_kayttotarkoitus import ListaKayttotarkoitus as Schema, ListaKayttotarkoitusPage as SchemaPage, ListaKayttotarkoitusCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_kayttotarkoitus")
def read_all(
    request: Request,
