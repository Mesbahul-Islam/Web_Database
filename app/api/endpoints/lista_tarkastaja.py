...
from app.models.lista_tarkastaja import ListaTarkastaja as Model  # lista_tarkastaja: list inspector
from app.schemas.lista_tarkastaja import ListaTarkastaja as Schema, ListaTarkastajaPage as SchemaPage, ListaTarkastajaCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_tarkastaja")
def read_all(
    request: Request,
