...
from app.schemas.lista_puutarhanerikoiskokoelma import ListaPuutarhanerikoiskokoelma as Schema, ListaPuutarhanerikoiskokoelmaPage as SchemaPage, ListaPuutarhanerikoiskokoelmaCreate as SchemaCreate
