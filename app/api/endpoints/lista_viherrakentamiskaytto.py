...
from app.models.lista_viherrakentamiskaytto import ListaViherrakentamiskaytto as Model  # lista_viherrakentamiskaytto: list landscape use
from app.schemas.lista_viherrakentamiskaytto import ListaViherrakentamiskaytto as Schema, ListaViherrakentamiskayttoPage as SchemaPage, ListaViherrakentamiskayttoCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_viherrakentamiskaytto")
def read_all(
    request: Request,
