...
from app.schemas.lista_alkuperainen_levinneisyys import ListaAlkuperainenLevinneisyys as Schema, ListaAlkuperainenLevinneisyysPage as SchemaPage, ListaAlkuperainenLevinneisyysCreate as SchemaCreate
