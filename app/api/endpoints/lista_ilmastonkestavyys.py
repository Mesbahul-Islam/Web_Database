...
from app.models.lista_ilmastonkestavyys import ListaIlmastonkestavyys as Model  # lista_ilmastonkestavyys: list climatic hardiness
from app.schemas.lista_ilmastonkestavyys import ListaIlmastonkestavyys as Schema, ListaIlmastonkestavyysPage as SchemaPage  # lista_ilmastonkestavyys: list climatic hardiness

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_ilmastonkestavyys")
def read_all(
    request: Request,
