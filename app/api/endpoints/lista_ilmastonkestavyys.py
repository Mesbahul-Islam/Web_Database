...
from app.schemas.lista_ilmastonkestavyys import ListaIlmastonkestavyys as Schema, ListaIlmastonkestavyysPage as SchemaPage, ListaIlmastonkestavyysCreate as SchemaCreate
