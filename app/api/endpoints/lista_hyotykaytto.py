...
from app.models.lista_hyotykaytto import ListaHyotykaytto as Model  # lista_hyotykaytto: list utilitarian use
from app.schemas.lista_hyotykaytto import ListaHyotykaytto as Schema, ListaHyotykayttoPage as SchemaPage, ListaHyotykayttoCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_hyotykaytto")
def read_all(
    request: Request,
