...
from app.models.lista_status import ListaStatus as Model  # lista_status: list status
from app.schemas.lista_status import ListaStatus as Schema, ListaStatusPage as SchemaPage, ListaStatusCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_status")
def read_all(
    request: Request,
