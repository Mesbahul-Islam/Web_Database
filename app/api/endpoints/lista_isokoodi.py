...
from app.models.lista_isokoodi import ListaIsokoodi as Model  # lista_isokoodi: list iso code
from app.schemas.lista_isokoodi import ListaIsokoodi as Schema, ListaIsokoodiPage as SchemaPage, ListaIsokoodiCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_isokoodi")
def read_all(
    request: Request,
