...
from app.schemas.lista_naytteentyyppi import ListaNaytteentyyppi as Schema, ListaNaytteentyyppiPage as SchemaPage, ListaNaytteentyyppiCreate as SchemaCreate
