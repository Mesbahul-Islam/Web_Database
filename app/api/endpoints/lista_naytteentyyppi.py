...
from app.schemas.lista_naytteentyyppi import ListaNaytteentyyppi as Schema, ListaNaytteentyyppiPage as SchemaPage  # lista_naytteentyyppi: list specimen type
