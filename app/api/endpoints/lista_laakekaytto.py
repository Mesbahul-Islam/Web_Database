...
from app.models.lista_laakekaytto import ListaLaakekaytto as Model  # lista_laakekaytto: list medicinal use
from app.schemas.lista_laakekaytto import ListaLaakekaytto as Schema, ListaLaakekayttoPage as SchemaPage, ListaLaakekayttoCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_laakekaytto")
def read_all(
    request: Request,
