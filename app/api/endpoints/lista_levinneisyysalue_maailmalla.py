...
from app.schemas.lista_levinneisyysalue_maailmalla import ListaLevinneisyysalueMaailmalla as Schema, ListaLevinneisyysalueMaailmallaPage as SchemaPage  # lista_levinneisyysalue_maailmalla: list distribution area worldwide
