...
from app.schemas.lista_levinneisyysalue_maailmalla import ListaLevinneisyysalueMaailmalla as Schema, ListaLevinneisyysalueMaailmallaPage as SchemaPage, ListaLevinneisyysalueMaailmallaCreate as SchemaCreate
