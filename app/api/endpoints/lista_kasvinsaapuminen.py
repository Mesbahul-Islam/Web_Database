...
from app.schemas.lista_kasvinsaapuminen import ListaKasvinsaapuminen as Schema, ListaKasvinsaapuminenPage as SchemaPage  # lista_kasvinsaapuminen: list plant arrival
