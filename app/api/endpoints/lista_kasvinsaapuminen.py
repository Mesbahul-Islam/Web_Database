...
from app.models.lista_kasvinsaapuminen import ListaKasvinsaapuminen as Model  # lista_kasvinsaapuminen: list plant arrival
from app.schemas.lista_kasvinsaapuminen import ListaKasvinsaapuminen as Schema, ListaKasvinsaapuminenPage as SchemaPage, ListaKasvinsaapuminenCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_kasvinsaapuminen")
def read_all(
    request: Request,
