...
from app.models.suomalainen_levinneisyysalue import SuomalainenLevinneisyysalue as Model
from app.schemas.suomalainen_levinneisyysalue import SuomalainenLevinneisyysalue as Schema, SuomalainenLevinneisyysaluePage as SchemaPage, SuomalainenLevinneisyysalueCreate as SchemaCreate
...
async def create_one(payload: SchemaCreate, current_user: Annotated[User, Depends(get_current_user)], db: Session = Depends(get_db)):
    invalidate_endpoint_cache("suomalainen_levinneisyysalue")
