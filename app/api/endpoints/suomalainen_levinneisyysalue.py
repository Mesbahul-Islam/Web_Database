...
from app.models.suomalainen_levinneisyysalue import SuomalainenLevinneisyysalue as Model  # suomalainen_levinneisyysalue: finnish_distribution_area
from app.schemas.suomalainen_levinneisyysalue import SuomalainenLevinneisyysalue as Schema, SuomalainenLevinneisyysaluePage as SchemaPage  # suomalainen_levinneisyysalue: finnish_distribution_area

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("suomalainen_levinneisyysalue")
def read_all(
    request: Request,
