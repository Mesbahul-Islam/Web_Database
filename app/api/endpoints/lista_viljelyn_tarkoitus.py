...
from app.models.lista_viljelyn_tarkoitus import ListaViljelynTarkoitus as Model  # lista_viljelyn_tarkoitus: list cultivation purpose
from app.schemas.lista_viljelyn_tarkoitus import ListaViljelynTarkoitus as Schema, ListaViljelynTarkoitusPage as SchemaPage  # lista_viljelyn_tarkoitus: list cultivation purpose

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_viljelyn_tarkoitus")
def read_all(
    request: Request,
