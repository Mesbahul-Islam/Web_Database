...
from app.schemas.lista_viljelyn_tarkoitus import ListaViljelynTarkoitus as Schema, ListaViljelynTarkoitusPage as SchemaPage, ListaViljelynTarkoitusCreate as SchemaCreate
