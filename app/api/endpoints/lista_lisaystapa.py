...
from app.models.lista_lisaystapa import ListaLisaystapa as Model  # lista_lisaystapa: list propagation method
from app.schemas.lista_lisaystapa import ListaLisaystapa as Schema, ListaLisaystapaPage as SchemaPage  # lista_lisaystapa: list propagation method

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_lisaystapa")
def read_all(
    request: Request,
