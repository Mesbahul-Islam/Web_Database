...
from app.schemas.lista_naytteensijainti import ListaNaytteensijainti as Schema, ListaNaytteensijaintiPage as SchemaPage, ListaNaytteensijaintiCreate as SchemaCreate
