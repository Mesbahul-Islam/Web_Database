...
from app.schemas.lista_kasvupaikka_suomessa import ListaKasvupaikkaSuomessa as Schema, ListaKasvupaikkaSuomessaPage as SchemaPage  # lista_kasvupaikka_suomessa: list growing site in finland

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_kasvupaikka_suomessa")
def read_all(
    request: Request,
