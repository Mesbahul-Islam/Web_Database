...
from app.models.lista_rauhoitukset import ListaRauhoitukset as Model  # lista_rauhoitukset: list protections
from app.schemas.lista_rauhoitukset import ListaRauhoitukset as Schema, ListaRauhoituksetPage as SchemaPage, ListaRauhoituksetCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_rauhoitukset")
def read_all(
    request: Request,
