...
from app.schemas.lista_alkuperatyyppi import ListaAlkuperatyyppi as Schema, ListaAlkuperatyyppiPage as SchemaPage  # lista_alkuperatyyppi: list origin type
