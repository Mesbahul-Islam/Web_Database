...
from app.schemas.lista_alkuperatyyppi import ListaAlkuperatyyppi as Schema, ListaAlkuperatyyppiPage as SchemaPage, ListaAlkuperatyyppiCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_alkuperatyyppi")
def read_all(
    request: Request,
