...
from app.models.lista_kieli import ListaKieli as Model  # lista_kieli: list language
from app.schemas.lista_kieli import ListaKieli as Schema, ListaKieliPage as SchemaPage, ListaKieliCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_kieli")
def read_all(
    request: Request,
