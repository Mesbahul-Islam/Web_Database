...
from app.models.lista_koristekaytto import ListaKoristekaytto as Model  # lista_koristekaytto: list ornamental use
from app.schemas.lista_koristekaytto import ListaKoristekaytto as Schema, ListaKoristekayttoPage as SchemaPage, ListaKoristekayttoCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_koristekaytto")
def read_all(
    request: Request,
