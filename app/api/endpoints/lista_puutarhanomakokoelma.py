...
from app.schemas.lista_puutarhanomakokoelma import ListaPuutarhanomakokoelma as Schema, ListaPuutarhanomakokoelmaPage as SchemaPage, ListaPuutarhanomakokoelmaCreate as SchemaCreate
