...
from app.models.lista_siemenia_jaljella import ListaSiemeniaJaljella as Model  # lista_siemenia_jaljella: list seeds left
from app.schemas.lista_siemenia_jaljella import ListaSiemeniaJaljella as Schema, ListaSiemeniaJaljellaPage as SchemaPage, ListaSiemeniaJaljellaCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_siemenia_jaljella")
def read_all(
    request: Request,
