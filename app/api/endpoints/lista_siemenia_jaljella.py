...
from app.schemas.lista_siemenia_jaljella import ListaSiemeniaJaljella as Schema, ListaSiemeniaJaljellaPage as SchemaPage  # lista_siemenia_jaljella: list seeds left
