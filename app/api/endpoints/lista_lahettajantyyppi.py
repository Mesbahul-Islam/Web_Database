...
from app.schemas.lista_lahettajantyyppi import ListaLahettajantyyppi as Schema, ListaLahettajantyyppiPage as SchemaPage  # lista_lahettajantyyppi: list sender type
