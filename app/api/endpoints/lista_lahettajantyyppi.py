...
from app.models.lista_lahettajantyyppi import ListaLahettajantyyppi as Model  # lista_lahettajantyyppi: list sender type
from app.schemas.lista_lahettajantyyppi import ListaLahettajantyyppi as Schema, ListaLahettajantyyppiPage as SchemaPage, ListaLahettajantyyppiCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_lahettajantyyppi")
def read_all(
    request: Request,
