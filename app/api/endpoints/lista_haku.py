...
from app.models.lista_haku import ListaHaku as Model  # lista_haku: list search
from app.schemas.lista_haku import ListaHaku as Schema, ListaHakuPage as SchemaPage, ListaHakuCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_haku")
def read_all(
    request: Request,
