...
from app.schemas.lista_maaritysmerkinta import ListaMaaritysmerkinta as Schema, ListaMaaritysmerkintaPage as SchemaPage, ListaMaaritysmerkintaCreate as SchemaCreate
