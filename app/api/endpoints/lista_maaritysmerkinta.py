...
from app.models.lista_maaritysmerkinta import ListaMaaritysmerkinta as Model  # lista_maaritysmerkinta: list identification_entry
from app.schemas.lista_maaritysmerkinta import ListaMaaritysmerkinta as Schema, ListaMaaritysmerkintaPage as SchemaPage  # lista_maaritysmerkinta: list identification_entry

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_maaritysmerkinta")
def read_all(
    request: Request,
