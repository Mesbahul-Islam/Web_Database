...
from app.models.lista_osasto import ListaOsasto as Model  # lista_osasto: list section
from app.schemas.lista_osasto import ListaOsasto as Schema, ListaOsastoPage as SchemaPage, ListaOsastoCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_osasto")
def read_all(
    request: Request,
