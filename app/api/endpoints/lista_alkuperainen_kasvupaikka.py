...
from app.schemas.lista_alkuperainen_kasvupaikka import ListaAlkuperainenKasvupaikka as Schema, ListaAlkuperainenKasvupaikkaPage as SchemaPage, ListaAlkuperainenKasvupaikkaCreate as SchemaCreate
