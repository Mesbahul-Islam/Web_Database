...
from app.schemas.lista_luonnonsuojeluarvo_suomessa import ListaLuonnonsuojeluarvoSuomessa as Schema, ListaLuonnonsuojeluarvoSuomessaPage as SchemaPage, ListaLuonnonsuojeluarvoSuomessaCreate as SchemaCreate
