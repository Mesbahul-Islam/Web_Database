...
from app.schemas.lista_luonnonsuojeluarvo_suomessa import ListaLuonnonsuojeluarvoSuomessa as Schema, ListaLuonnonsuojeluarvoSuomessaPage as SchemaPage  # lista_luonnonsuojeluarvo_suomessa: list_nature_conservation_value_in_finland

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_luonnonsuojeluarvo_suomessa")
def read_all(
    request: Request,
