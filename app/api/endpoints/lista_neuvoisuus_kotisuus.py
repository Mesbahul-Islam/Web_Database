...
from app.schemas.lista_neuvoisuus_kotisuus import ListaNeuvoisuusKotisuus as Schema, ListaNeuvoisuusKotisuusPage as SchemaPage, ListaNeuvoisuusKotisuusCreate as SchemaCreate
