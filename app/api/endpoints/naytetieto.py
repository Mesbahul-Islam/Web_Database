...
from app.models.naytetieto import Naytetieto as Model  # naytetieto: specimen_data
from app.schemas.naytetieto import Naytetieto as Schema, NaytetietoCreate as SchemaCreate, NaytetietoPage as SchemaPage  # naytetieto: specimen_data

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("naytetieto")
def read_all(
    request: Request,
