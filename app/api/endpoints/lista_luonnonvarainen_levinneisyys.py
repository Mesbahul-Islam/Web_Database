...
from app.schemas.lista_luonnonvarainen_levinneisyys import ListaLuonnonvarainenLevinneisyys as Schema, ListaLuonnonvarainenLevinneisyysPage as SchemaPage, ListaLuonnonvarainenLevinneisyysCreate as SchemaCreate
