...
from app.schemas.lista_luonnonvarainen_levinneisyys import ListaLuonnonvarainenLevinneisyys as Schema, ListaLuonnonvarainenLevinneisyysPage as SchemaPage  # lista_luonnonvarainen_levinneisyys: list wild distribution

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_luonnonvarainen_levinneisyys")
def read_all(
    request: Request,
