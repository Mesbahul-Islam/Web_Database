...
from app.models.lista_varsi import ListaVarsi as Model  # lista_varsi: list stem
from app.schemas.lista_varsi import ListaVarsi as Schema, ListaVarsiPage as SchemaPage, ListaVarsiCreate as SchemaCreate

router = APIRouter()

@router.get("/", response_model=SchemaPage)
@cached_list("lista_varsi")
def read_all(
    request: Request,
