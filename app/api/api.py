...
from app.api.endpoints.osastolla import router as osastolla_router
api_router.include_router(osastolla_router, prefix="/osastolla", tags=["Osastolla"])

from app.api.endpoints.raportit import router as raportit_router
api_router.include_router(raportit_router, prefix="/raportit", tags=["Raportit"])
